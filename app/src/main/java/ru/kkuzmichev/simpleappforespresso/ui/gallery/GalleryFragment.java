...
public class GalleryFragment extends Fragment {
    ...
    private GalleryViewModel galleryViewModel = new ViewModelProvider(this).get(GalleryViewModel.class);
    private FragmentGalleryBinding binding;
    private RecyclerView recyclerView;
    private final ArrayList<GalleryItem> itemList = new ArrayList<>();
